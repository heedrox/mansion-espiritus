...
const syns = {
  ...
  items: {
    ...
    'libro-espiritus-recib': ['libro sobre espíritus', 'lectura de espíritus', 'libro sobre los espíritus','libro con espíritus', 'el de los espíritus', 'libro de espectros', 'libros de expectros'],
